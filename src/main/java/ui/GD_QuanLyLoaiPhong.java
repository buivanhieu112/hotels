 ...
 * @author admin
 */
public class GD_QuanLyLoaiPhong extends javax.swing.JFrame {
	...
	/**
     * Creates new form GD_QuanLyLoaiPhong
     */
    public GD_QuanLyLoaiPhong() {
        initComponents();
        setExtendedState(GD_QuanLyLoaiPhong.MAXIMIZED_BOTH);

    }
    
    
    private DefaultTableModel modelDSLP;
    private String[] colsLoaiPhong={"Mã loại phòng", "Tên loại phòng", "Giá Phòng"};
    
    public void DocDuLieuDatabaseVaoDSLoaiPhong() {
    	ArrayList<LoaiPhong> listPhong = DAO_LoaiPhong.getAllLoaiPhong();
    	for (LoaiPhong p : listPhong) {
    		modelDSLP.addRow(new Object[] {
    				p.getMaLP(),p.getTenLP(),p.getGiaLP()
    				});}
        }
    
    public void DocDuLieuVaoTextFiedLoaiPhong()
    {
    	ArrayList<LoaiPhong> lstP = DAO_LoaiPhong.getAllLoaiPhong();
		int i = tblDSLP.getSelectedRow();
		if(i!=-1) {
			LoaiPhong p = lstP.get(i);
			txtMaLoaiPhong.setText(p.getMaLP());
			txtTenLoaiPhong.setText(p.getTenLP());
			txtGiaTien.setText(String.valueOf(p.getGiaLP()));
		}
    }
    ...
    public String maLoaiPhongMoi() {
    	...
    	String ma = listPhong.get(listPhong.size()-1).getMaLP().substring(2);
    ...
    public void LamMoiTextField() {
    	txtMaLoaiPhong.setText(maLoaiPhongMoi());
...
// Them
    public boolean themPhong() throws ParseException {
    	String maPhong, tenPhong, gia;
    	double giaPhong;
    	if(kiemTraDuLieuPhong()) {
    		maPhong = txtMaLoaiPhong.getText();
        	tenPhong = txtTenLoaiPhong.getText();
        	gia= txtGiaTien.getText();
        	giaPhong = Double.valueOf(gia);
        	
        	LoaiPhong p = new LoaiPhong(maPhong, tenPhong, giaPhong);
        	if(!DAO_LoaiPhong.themLP(p))
        		return false;
    ...
    public boolean kiemTraDuLieuPhong() {
		String tenDV=txtTenLoaiPhong.getText().trim();
...
// xoa phong    
    public boolean kiemTraTonTai() {
    	...
    	String st = txtMaLoaiPhong.getText();
    	for(Phong p: listP) {
    		if(p.getLoaiPhong().getMaLP().equalsIgnoreCase(st)) {
...
public boolean xoaLP() {
        ...
        if (result == JOptionPane.YES_OPTION) {
        	ArrayList<Phong> listp = DAO_Phong.getAllPhong();
        	for(Phong p: listp) {
        		if(p.getLoaiPhong().getMaLP().equalsIgnoreCase(txtMaLoaiPhong.getText())) {
        			JOptionPane.showMessageDialog(rootPane, "Loại phòng đang được sử dụng, không thể xóa!");
        			return false;
        		}
        	}
        	DAO_LoaiPhong.xoaLP(txtMaLoaiPhong.getText());
...
// tim phong
	...
	public void timLP(String ten) {
		ArrayList<LoaiPhong> listPhong = DAO_LoaiPhong.timLP(ten);
		for (LoaiPhong p : listPhong) {
			modelDSLP.addRow(new Object[] {
					p.getMaLP(),p.getTenLP(),p.getGiaLP()
					});}
    ...
    private void initComponents() {
        ...
        scrollDSLP = new javax.swing.JScrollPane();
        tblDSLP = new javax.swing.JTable();
        ...
        jLabel9.setText("Thông Tin Loại Phòng");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel4.setText("Giá Loại Phòng");
        ...
        pnlTTNVLayout.setVerticalGroup(
            ...
            .addGroup(pnlTTNVLayout.createSequentialGroup()
                ...
                .addGroup(pnlTTNVLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlTTNVLayout.createSequentialGroup()
                        .addGap(4, 4, 4)
                        .addComponent(txtMaLoaiPhong, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(10, 10, 10)
                .addGroup(pnlTTNVLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtTenLoaiPhong, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel3))
                .addGap(18, 18, 18)
                .addGroup(pnlTTNVLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        tblDSLP.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        pnlDSNVLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlDSNVLayout.createSequentialGroup()
                ...
                .addComponent(scrollDSLP, javax.swing.GroupLayout.DEFAULT_SIZE, 606, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        pnlBottomLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlBottomLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btnDangXuat, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(34, 34, 34))
        );
        ...
        tblDSLP = new JTable(modelDSLP);
        scrollDSLP.setViewportView(tblDSLP);
        
//        tblDSPhong.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        tblDSLP.getColumnModel().getColumn(0).setPreferredWidth(80);
        tblDSLP.getColumnModel().getColumn(1).setPreferredWidth(152);
        tblDSLP.getColumnModel().getColumn(2).setPreferredWidth(150);
        
        // Sự kiện click trên tblDSPhongTrong
        ListSelectionModel listSelectionModelDSPhongTrong = tblDSLP.getSelectionModel();
...
//        	GD_DaiSanh uiDaiSanh = new GD_DaiSanh();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GD_QuanLyLoaiPhong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JScrollPane scrollDSLP;
    private javax.swing.JTable tblDSLP;
