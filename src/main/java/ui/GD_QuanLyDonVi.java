 ...
 * @author admin
 */
public class GD_QuanLyDonVi extends javax.swing.JFrame {
	...
	/**
     * Creates new form GD_QuanLyDonVi
     */
    public GD_QuanLyDonVi() {
        initComponents();
        setExtendedState(GD_QuanLyDonVi.MAXIMIZED_BOTH);
    }
    
    private DefaultTableModel modelDSDV;
    private String[] colsDonVi={"Mã đơn vị", "Tên đơn vị"};
    
    public void DocDuLieuDatabaseVaoDSDV() {
    	ArrayList<DonVi> listPhong = DAO_DonVi.getAllDonVi();
    	for (DonVi p : listPhong) {
    		modelDSDV.addRow(new Object[] {
    				p.getMaDonVi(),p.getTenDonVi()
    				});}
        }
    ...
    {
    	ArrayList<DonVi> listPhong = DAO_DonVi.getAllDonVi();
		int i = tblDSDonVi.getSelectedRow();
		if(i!=-1) {
			DonVi p = listPhong.get(i);
			txtMaDonVi.setText(p.getMaDonVi());
			txtTenDonVi.setText(p.getTenDonVi());
		}
    }
    ...
    public String maDVMoi() {
    	...
    	String ma = listPhong.get(listPhong.size()-1).getMaDonVi().substring(3);
...
//    	double giaPhong;
    	if(kiemTraDuLieuDV()) {
    		maPhong = txtMaDonVi.getText();
        	tenPhong = txtTenDonVi.getText();
        	
        	DonVi p = new DonVi(maPhong, tenPhong);
        	if(!DAO_DonVi.themDonVi(p))
        		return false;
        	JOptionPane.showMessageDialog(rootPane, "Thêm đơn vị thành công!");
    ...
    public boolean kiemTraDuLieuDV() {
		String tenDV=txtTenDonVi.getText().trim();
...
public boolean xoaDV() {
        ...
        if (result == JOptionPane.YES_OPTION) {
        	DAO_LoaiPhong.xoaLP(txtMaDonVi.getText());
...
// tim phong
	...
	public void timDV(String ten) {
		ArrayList<DonVi> listPhong = DAO_DonVi.timDonVi(ten);
		for (DonVi p : listPhong) {
			modelDSDV.addRow(new Object[] {
					p.getMaDonVi(),p.getTenDonVi()
					});}
...
//    @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        tblDSDonVi = new javax.swing.JTable();
        ...
        txtMaDonVi.setBackground(new java.awt.Color(153, 153, 153));
        ...
        jLabel9.setText("THÔNG TIN ĐƠN VỊ");
        ...
        pnlTTNVLayout.setVerticalGroup(
            ...
            .addGroup(pnlTTNVLayout.createSequentialGroup()
                ...
                .addGroup(pnlTTNVLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlTTNVLayout.createSequentialGroup()
                        .addGap(4, 4, 4)
                        .addComponent(txtMaDonVi, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(pnlTTNVLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel3)
                    .addGroup(pnlTTNVLayout.createSequentialGroup()
                        .addGap(4, 4, 4)
                        .addComponent(txtTenDonVi, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(50, 50, 50)
        ...
        tblDSDonVi.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        pnlDSNVLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlDSNVLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(scrollDSLP, javax.swing.GroupLayout.DEFAULT_SIZE, 611, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        modelDSDV = new DefaultTableModel(colsDonVi,0);
        tblDSDonVi = new JTable(modelDSDV);
        scrollDSLP.setViewportView(tblDSDonVi);
        
//        tblDSPhong.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        tblDSDonVi.getColumnModel().getColumn(0).setPreferredWidth(80);
        tblDSDonVi.getColumnModel().getColumn(1).setPreferredWidth(152);

        
        // Sự kiện click trên tblDSPhongTrong
        ListSelectionModel listSelectionModelDSPhongTrong = tblDSDonVi.getSelectionModel();
...
//        	GD_DaiSanh uiDaiSanh = new GD_DaiSanh();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GD_QuanLyDonVi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GD_QuanLyDonVi().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblDSDonVi;
